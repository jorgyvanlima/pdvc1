...
const navigation = [
    ...
    { name: 'Contas a Pagar', href: '/dashboard/financial/payables', icon: ArrowDownCircle },
    { name: 'Contas a Receber', href: '/dashboard/financial/receivables', icon: ArrowUpCircle },
