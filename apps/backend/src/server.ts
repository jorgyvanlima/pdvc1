...
import dailyCashRoutes from './routes/dailyCash.routes';
import paymentAlertsRoutes from './routes/paymentAlerts.routes';
...
// Financial module routes
app.use(`${API_PREFIX}/finance/accounts-payable`, accountsPayableRoutes);
app.use(`${API_PREFIX}/finance/accounts-receivable`, accountsReceivableRoutes);
app.use(`${API_PREFIX}/finance/daily-cash`, dailyCashRoutes);
app.use(`${API_PREFIX}/finance/alerts`, paymentAlertsRoutes);
app.use(`${API_PREFIX}/finance/dashboard`, financialDashboardRoutes);
